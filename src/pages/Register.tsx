          ...
          {signInImage ? (
            ...
            <div className={`w-full h-full flex items-center justify-center ${isDark ? 'bg-[#0A2540]' : 'bg-gray-200'}`}>
              <div className="text-center">
                <UserPlus className={`w-32 h-32 mx-auto mb-4 ${isDark ? 'text-[#F5B729]' : 'text-[#1A8754]'}`} />
                <h2 className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-gray-900'}`}>Join Us Today</h2>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-12">
          <div className="max-w-md w-full">
            <div className={`${isDark ? 'bg-gradient-to-br from-[#0A2540] to-[#0D3158] border-[#1A3A5C]' : 'bg-white border-gray-200'} p-8 rounded-xl shadow-2xl border`}>
              ...
              <h2 className={`text-3xl font-bold text-center mb-8 ${isDark ? 'text-white' : 'text-gray-900'}`}>Create Account</h2>
              ...
              <div className="mt-6 text-center">
                <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
                  ...
                  <Link to="/login" className={`${isDark ? 'text-[#F5B729] hover:text-[#E3A82A]' : 'text-[#1A8754] hover:text-[#156642]'} transition-colors`}>
                    Sign in
                  </Link>
                </p>
              </div>
